      ...
      <Container>
        <div className="flex flex-col gap-10">
          <div className="px-[8.75rem]">
            <Label variant={"summaryRegular"} className="block text-center">
              <p>국내 최고 수준의 서비스들이</p>
            ...
            <div className="mx-auto flex h-[25.625rem] w-full items-center justify-between">
              <div className="max-w-lg">
                <Label variant="title" className="!mb-[1.875rem] block">
                  하나의 SDK로 광고 사업에 <br />
                  필요한 모든 기능을 제공합니다.
                </Label>
                <Label variant={"bodyRegular"} className="block w-[25rem]">
                  <Label variant={"bodySemiBold"} className="mb-2 block">
            ...
            <div className="mx-auto flex h-[25.625rem] w-full items-center justify-between">
              ...
              <div className="max-w-lg">
                ...
                <Label variant={"bodyRegular"} className="mb-2 block w-[25rem]">
